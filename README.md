...
> *"Je construis des choses qui marchent. Puis je les rends belles."*
...
`Spring Boot` `React.js` `Java` `JWT` `TailwindCSS` `WebSocket` `Microservices`

🔗 [Voir le projet](https://ismailstarallah.dev/#projets)
...
> Un modèle de régression logistique entraîné sur des données de transactions réelles pour détecter les fraudes avec une précision élevée.

**Ce que ça fait :** Pipeline ML complet avec traitement des données déséquilibrées, tableau de bord interactif pour visualiser les prédictions, et exposition via APIs REST.

`Python` `Django` `Scikit-learn` `Pandas` `REST API`
...
> Connecter les associations caritatives aux donateurs de manière sécurisée et centralisée.

**Ce que ça fait :** Gestion des initiatives, sécurité avancée avec Spring Security, intégration de paiements et suivi des actions en temps réel.
...
> Script Bash pour collecter, stocker et analyser les métriques de performance système (CPU, mémoire, disque, réseau) avec rapports textuels et graphiques ASCII.
...
|---|---|:---:|
| 🏆 Oracle Certified Professional: Java SE 17 Developer | Oracle | 2025 |
| 🎓 Meta Front-End Developer | Meta | 2024 |
| 🐧 Fundamentals of Red Hat Enterprise Linux | Red Hat | 2024 |
| ☕ Introduction to Java and OOP | University of Pennsylvania | 2025 |
| 💻 Learn C Skill Path | Codecademy | 2025 |
| 🔧 The Unix Workbench | Johns Hopkins University | 2024 |
| 🧮 Introduction à la POO (C++) | EPFL | 2024 |
| 🏗️ Software Engineering: Design & Project Management | HKUST | 2024 |
| 🤖 Data Balancing with Gen AI: Credit Card Fraud Detection | Coursera | 2024 |
| ☕ Initiation à la programmation (Java) | EPFL | 2024 |
